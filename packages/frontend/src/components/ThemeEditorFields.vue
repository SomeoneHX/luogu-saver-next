...
/** The theme editor's form itself — shared by the desktop drawer and the mobile glass sheet. */
...
<template>
            ...
            <n-collapse>
                <n-collapse-item title="主要" name="main">
                    ...
                    <n-form-item label="代码主题" path="codeTheme">
                        <n-select v-model:value="uiTheme.codeTheme" :options="codeThemeOptions" />
                    </n-form-item>
                </n-collapse-item>
    ...
    <n-space v-if="mode !== 'auto'" justify="end" class="theme-actions">
